  ...
  let(:valid_attributes) {
    {
        ...
        gender: "Male",
        additional_info: "Additional String",
        portfolio_url: "http://www.portfolio.com",
        linkedin_url: "http://www.linkedin.com/in/123456",
        current_company: "Google",
        disability_status: "I don't wish to answer",
        veteran_status: "I identify as a protected veteran",
        race: "White",
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested application" do
        ...
        application.reload
        expect(application.gender).to eq("Female")
